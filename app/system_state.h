...
typedef enum 
{
    KK_RREBOOT_UNKNOWN = -1,
    KK_REBOOT_CMD = 0,
    KK_REBOOT_UPDATE = 1,
    KK_REBOOT_POWER_ON = 2,
    KK_REBOOT_GPRS = 3,
    KK_REBOOT_GPS = 4,
    KK_REBOOT_CHECKPARA = 5,
}BootReason;


typedef enum
{
    KK_SYSTEM_STATE_WORK = 0,
    KK_SYSTEM_STATE_SLEEP = 1
}SystemWorkState;
 ...
 * Others:      
 */
KK_ERRCODE system_state_set_vehicle_state(const VehicleState work_state);
...
KK_ERRCODE system_state_set_highvoltage_alarm(bool state);
