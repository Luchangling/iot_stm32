 ...
 * Others:	   
 */
KK_ERRCODE gps_service_push_gps(GpsDataModeEnum mode, const GPSData *p_gps_data);
 ...
 * Others:	   
 */
KK_ERRCODE gps_service_temperature_atonce(void);
 ...
 * Others:	   
 */
KK_ERRCODE gps_service_push_wifi(void);
...
KK_ERRCODE gps_service_push_recorder_response_state(bool start);


KK_ERRCODE gps_service_send_one_recorder_file_pack(void *arg);
...
KK_ERRCODE gps_service_cache_send(u8 *data, u8 len);
