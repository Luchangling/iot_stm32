...
my $mark_oem_code = "CFG_CUSTOM_CODE";
...
my $cfile = $dir."/driver/fs/config_service.h";

my $ofile = $dir."/output/GmAppMain.ex";

my $bfile = $dir."/MDK/kk_os.bin";
...
my $build_bfile = $bfile;   #$dir."/build/GmAppMain.bin";

#my $out_ofile = $dir."/output/GmAppMain.ex";

my $out_bfile = $dir."/output/kk_os.bin";

my $update_file = $dir."/output/kk_os.m";
...
rename($update_file,$dir."/output/".$new_name."T100.m");
