...
#define GET_BIT0(val)   (bool)(((val) & BIT0)?1:0)
#define GET_BIT1(val)   (bool)(((val) & BIT1)?1:0)
#define GET_BIT2(val)   (bool)(((val) & BIT2)?1:0)
#define GET_BIT3(val)   (bool)(((val) & BIT3)?1:0)
#define GET_BIT4(val)   (bool)(((val) & BIT4)?1:0)
#define GET_BIT5(val)   (bool)(((val) & BIT5)?1:0)
#define GET_BIT6(val)   (bool)(((val) & BIT6)?1:0)
#define GET_BIT7(val)   (bool)(((val) & BIT7)?1:0)
#define GET_BIT8(val)   (bool)(((val) & BIT8)?1:0)
#define GET_BIT9(val)   (bool)(((val) & BIT9)?1:0)
#define GET_BIT10(val)  (bool)(((val) & BIT10)?1:0)
#define GET_BIT11(val)  (bool)(((val) & BIT11)?1:0)
#define GET_BIT12(val)  (bool)(((val) & BIT12)?1:0)
#define GET_BIT13(val)  (bool)(((val) & BIT13)?1:0)
#define GET_BIT14(val)  (bool)(((val) & BIT14)?1:0)
#define GET_BIT15(val)  (bool)(((val) & BIT15)?1:0)

#define GET_BIT16(val)  (bool)(((val) & BIT16)?1:0)
#define GET_BIT17(val)  (bool)(((val) & BIT17)?1:0)
#define GET_BIT18(val)  (bool)(((val) & BIT18)?1:0)
#define GET_BIT19(val)  (bool)(((val) & BIT19)?1:0)
#define GET_BIT20(val)  (bool)(((val) & BIT20)?1:0)
#define GET_BIT21(val)  (bool)(((val) & BIT21)?1:0)
#define GET_BIT22(val)  (bool)(((val) & BIT22)?1:0)
#define GET_BIT23(val)  (bool)(((val) & BIT23)?1:0)
#define GET_BIT24(val)  (bool)(((val) & BIT24)?1:0)
#define GET_BIT25(val)  (bool)(((val) & BIT25)?1:0)
#define GET_BIT26(val)  (bool)(((val) & BIT26)?1:0)
#define GET_BIT27(val)  (bool)(((val) & BIT27)?1:0)
#define GET_BIT28(val)  (bool)(((val) & BIT28)?1:0)
#define GET_BIT29(val)  (bool)(((val) & BIT29)?1:0)
#define GET_BIT30(val)  (bool)(((val) & BIT30)?1:0)
#define GET_BIT31(val)  (bool)(((val) & BIT31)?1:0)
...
extern KK_ERRCODE ConvertIpAddr(u8 *addr , u8 *ip);
 ...
 * Others:	   
 */
KK_ERRCODE util_timer_proc(void);
 ...
 * Others:	   无
 */
//KK_ERRCODE util_get_current_local_time(u8* pdata, ST_Time* time, u8 zone);
 ...
 * Return:     KK_CHANGE_TRUE——变为true状态；KK_NO_CHANGE——不变；KK_CHANGE_FALSE——变为false状态
 * Others:      
 */	
KK_CHANGE_ENUM util_check_state_change(bool current_state, PStateRecord p_record, U16 true_hold_time_threshold, U16 false_hold_time_threshold);
#endif

KK_ERRCODE ConvertIpAddr(u8 *addr , u8 *ip);

time_t util_get_utc_time(void);

bool util_arry_compare(u8 *a1 , u8* a2 , u16 len);

KK_ERRCODE util_convertipaddr(u8 *addr , u8 *ip);

u16 util_memcpy_until_speical(u8 *in,u8*out,u8 a , u16 max_len);
