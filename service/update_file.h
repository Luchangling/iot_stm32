...
#define UPDATE_UPGRADE_FILE               SYS_FILE_NAME
#define UPDATE_TARGET_IMAGE               SYS_FILE_NAME
#define UPDATE_MINOR_IMAGE                SYS_FILE_NAME
...
#define UPDATE_MAX_PACK_ONE_SEND       3 //每次发送包数      //不可超过30，remember fifo size should also modified
